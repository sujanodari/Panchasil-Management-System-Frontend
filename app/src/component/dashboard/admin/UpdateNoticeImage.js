...
class UpdateNoticeImage extends Component {
  constructor(props) {
    super(props);
        ...
        <div className="container fixed">
          ...
          <Form>
            ...
            <Form.Group controlId="formBasicEmail3">
              ...
              {this.state.notice.image == null ? (
                <Card.Img variant="top" src={NoImage} className="fix-image" />
              ) : (
                <a
                  href={`http://localhost:3012/images/${this.state.notice.image}`}
                >
                  <Card.Img
                    variant="top"
                    src={`http://localhost:3012/images/${this.state.notice.image}`}
                    className="fix-image"
                    alt="image not found"
                  />
                </a>
