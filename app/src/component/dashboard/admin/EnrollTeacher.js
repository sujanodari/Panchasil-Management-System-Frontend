...
class EnrollStudent extends Component {
  ...
  enroll = (e) => {
    ...
    if (this.state.year === "") {
      ...
      this.state.section === "" ||
      this.state.section === "Choose section"
    ) {
      this.setState({
        cerror: true,
        Verror: false,
      ...
      axois
        .post(
          `http://localhost:3012/api/v1/enrollTeacher/${this.state.student_id}`,
          this.state,
          this.state.config
        )
        .then((response) => {
      ...
      <div>
        <>
          ...
          <div className="container fixed">
            <p align="center">Enroll Teacher</p>
            {this.state.Verror === true ? (
              <label className="labelColor">Validation error</label>
            ) : null}
            {this.state.cerror === true ? (
              <label className="labelColor">Choose right input fields</label>
            ) : null}
            ...
            <Form>
              ...
              <Form.Group controlId="year">
                ...
                {this.state.errors.year ? (
                  <label className="labelColor" name="year">
                    {this.state.errors.year}
                  </label>
                ) : null}
              </Form.Group>
