          ...
          <div className="row">
            <div className="col-md-8">
              <Card className="text-center fix-news mycard">
                ...
                <small>
                  <a href={`profilePictureUpdate/${this.state.user.userId}`}>
                    {" "}
                    ...
                    <div className="container">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          ...
                          <a
                            href={`/profileUpdate/${this.state.user.userId}`}
                            className="btn-block"
                          >
                            Edit Profile
                          </a>
            ...
            <div className="col-md-4">
              ...
              <div className="container">
                ...
                >
                  ...
                  <Card.Body>
                    <Card.Title>All subjects</Card.Title>
                    <Card.Text>Subject Names</Card.Text>
                  </Card.Body>
                </Card>
              </div>
            </div>
